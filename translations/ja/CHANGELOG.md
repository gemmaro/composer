  * Added repository management command `repo` to add, insert, remove and
    update repositories (#9918)
  * Changed repository structure to contain a name attribute and is stored
    preferably as list instead of object (#9918)
